...
<GuiaResumen
  ...
  relacionadas={[
    { n: '02', titulo: 'Casos y glosario', href: '/docs/guides/02-guia-practica-y-ejemplos-para-entender-el-reglamento-de-ia' },
    { n: '16', titulo: 'Checklists', href: '/docs/guides/16-manual-de-checklist-de-guias-de-requisitos' },
  ]}
/>
