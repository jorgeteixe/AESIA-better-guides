---
title: "13 Guía Vigilancia poscomercialización"
description: "Seguimiento continuo del rendimiento tras la puesta en servicio."
---
...
4.  ¿Qué elementos implantar y cómo debo hacerlo para desarrollar un adecuado sistema de vigilancia poscomercialización? ....................................................13
5.  Otros elementos a considerar ...................................................................24
6.  Documentación técnica ............................................................................26
7.  Anexos .....................................................................................................27
8.  Referencias ..............................................................................................34
...
4.  ¿Qué elementos implantar y cómo debo hacerlo para desarrollar un adecuado sistema de vigilancia poscomercialización? ....................................................13
    4.1 Vigilancia continua ............................................................................15
    4.2 Vigilancia periódica ............................................................................17
    4.3 Informes de incidentes .......................................................................19
    4.4 Comunicación transparente .................................................................20
    4.5 Capacitación ......................................................................................21
    4.6 Flexibilidad .........................................................................................22
5.  Otros elementos a considerar ...................................................................24
    5.1 Conexiones con otras guías ................................................................24
6.  Documentación técnica ............................................................................26
7.  Anexos .....................................................................................................27
    7.1 Anexo A - Indicadores de vigilancia ...................................................27
        7.1.1 Anexo A.I - Indicadores sobre el sistema inteligente ..................28
        7.1.2 Anexo A.II - Indicadores sobre la infraestructura ........................30
        7.1.3 Anexo A.III - Indicadores sobre las acciones de los usuarios ......31
        7.1.4 Anexo A.IV - Indicadores de seguridad ......................................32
8.  Referencias ..............................................................................................34
...
2.  **Desarrollo del sistema de vigilancia poscomercialización**: sección 4 de la guía donde se explica cómo desarrollar e implementar el sistema de vigilancia además de las medidas que deben de estar contempladas en el plan de vigilancia. Antes de su lectura, se recomienda revisar el Anexo A para profundizar en el concepto de indicador y los listados de indicadores mínimos.
...
>
> Pongamos el caso de una empresa que ha implementado un sistema de IA para evaluar la promoción de personal, que se basa en una variedad de parámetros y datos recopilados de los empleados. El sistema ha sido validado y aprobado por los reguladores pertinentes y ha sido lanzado al mercado.
>
...
|         Sistema de obtención y procesamiento de datos para la vigilancia |
+------------------------------------------------------------------+
| Captación de indicadores   | Registro de indicadores | Sistema de alertas y Dashboards |
...
+------------------------------------------------------------------+
|                       Plan de vigilancia                         |
|           Protocolos y asignación de responsabilidades para la vigilancia |
+------------------------------------------------------------------+
| Definir, documentar  | Realizar Vigilancia contínua | Realizar Vigilancia periódica | Seguimiento y revisión continua |
| e implementar el sistema | (cambios abruptos)   | (cambios paulatinos) | Comunicación y consulta |
| de vigilancia        |                          |                      | Formación de vigilantes |
+----------------------+--------------------------+----------------------+---------------------------+
```
...
```
+---------------------------+       +-----------------------------------+
| Fase previa al diseño del |       | Diseño del Sistema de Vigilancia  |
| Sistema de Vigilancia     |       +-----------------------------------+
+---------------------------+       |                                   |
|                           |       | Indicadores seleccionados         |
| 1. Desarrollo de la Guía  |       |                                   |
|    Gestión de Riesgos     |       +-----------------------------------+
|                           |       | Componentes del sistema (Punto 1.2) |
| 2. Desarrollo de Guías de |       |                                   |
|    Precisión, Solidez y   |-------&gt; Sistemas de registro de indicadores &lt;----- Sistemas de captación de indicadores |
|    Ciberseguridad.        |       |                                   |
|                           |       | Sistema de alertas automatizadas  |-----&gt; Interfaz de análisis para supervisores |
| 3. Desarrollo de Guía de  |       |                                   |
|    Conservación de registros |       +-----------------------------------+
|                           |       | Medidas del sistema (Punto 2)     |
| 4. Desarrollo de Guías de |       |                                   |
|    Supervisión humana.    |-------&gt; Monitorización contínua           |-----&gt; Monitorización periódica           |
|                           |       | Monitorear el rendimiento y el    |       | Llevar a cabo evaluaciones         |
|                           |       | comportamiento del sistema de IA  |       | regulares para medir el rendimiento |
|                           |       | en un entorno de producción para  |       | y la precisión del sistema de IA   |
|                           |       | detectar y corregir problemas en  |       | comparando los indicadores de      |
|                           |       | tiempo real                       |       | manera más dilatada en el tiempo   |
+---------------------------+       +-----------------------------------+
|                           |       | Informes de incidentes            |-----&gt; Comunicación transparente       |
| Fase posterior al diseño  |       |                                   |       |                                   |
| del Sistema de Vigilancia |       | Capacitación                      |-----&gt; Flexibilidad                    |
+---------------------------+       +-----------------------------------+
| 1. Desarrollo de la       |
...
Hay que tener en cuenta que los sistemas de IA operan en entornos cambiantes, y pueden verse afectados por cambios en los datos de entrada, las condiciones del entorno, y las regulaciones. La vigilancia continua de los indicadores seleccionados tras la evaluación de riesgos permite detectar y corregir problemas relacionados con estos cambios.
...
*   **Guía de Precisión**: Se hace referencia a la necesidad de evaluar la degradación del modelo a través de la vigilancia con *dashboards* y herramientas de visualización de la precisión. Para ello se deberá de seleccionar previamente las métricas de precisión asociadas al modelo de IA (sección de la Guía de Precisión: “Métricas de precisión asociadas al modelo de IA”) y los niveles de precisión pertinentes para el sistema (sección de la Guía de Precisión: “Niveles de Precisión, Documentación y Monitorización de los modelos de IA").
...
2.  **Documentación detallada sobre las medidas del plan de vigilancia poscomercialización**. Deberá de incluir al menos:
...
| Tasa de errores de predicción\*         | Porcentaje de predicciones incorrectas sobre el total de predicciones realizadas. Ejemplo: 3% | Rango de tolerancia para errores. Ejemplo: 0% - 10%                                                            |
...
| Medidas estadísticas de los *inputs* introducidos por usuario | Mismos datos que “Variación en las medidas estadísticas de los *inputs*” de la tabla de indicadores sobre el sistema inteligente, pero asociando dichas métricas con un usuario en particular.                                                                                             | Misma escala que “Variación en las medidas estadísticas de los *inputs*” de la tabla de indicadores sobre el sistema inteligente, pero asociando dichas métricas con un usuario en particular.                                                                                             |
